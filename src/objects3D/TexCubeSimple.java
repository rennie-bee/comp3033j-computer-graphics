...
// This class draw a texture on cube, which puts the whole picture on one surface
public class TexCubeSimple {


    public TexCubeSimple() {

    }

    public void DrawTexCubeSimple(Texture myTexture)
    {
